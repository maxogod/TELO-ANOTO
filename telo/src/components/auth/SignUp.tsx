...
const SignUp = ({ setUser }: { setUser: setUserFunction }) => {
  ...
  return (
    <>
      ...
      <div className="flex items-center justify-center flex-col opacity-95">
        <h1 className="text-3xl leading-7 text-white mb-5">Sumate a TeloBusco!</h1>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col items-center gap-3'>
          ...
          {labels.map((label, index) => (
            <div key={index}>
              ...
              <label htmlFor={label.userProp} className='flex items-center'>
